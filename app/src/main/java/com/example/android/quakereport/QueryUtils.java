    ...
    * */
    ...
    private static String makeHttpRequest(URL url) throws IOException{
        ...
        try{
            ...
            if (inputStream!=null){
                //closing the input stream could through an IOException, which is why
                //the makeHttpRequest(URL url) method signature specifies than IOException
                //could be thrown.
                inputStream.close();
            }
        }
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                //key called "properties", which represent a list of all properties
                // for that earthquake
